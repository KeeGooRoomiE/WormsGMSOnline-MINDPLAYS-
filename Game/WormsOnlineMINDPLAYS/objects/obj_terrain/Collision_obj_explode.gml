...
var terrain_surface = surface_create(w,h);
...
with(other)
{
	draw_sprite_ext(spr_expl_mask,0,x-other.x+other.xo,y-other.y+other.yo,image_xscale/expl_scale,image_yscale/expl_scale,0,c_white,1);;
}
